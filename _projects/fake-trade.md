---
title: Fake Trade
intro: A deep dive into the industry behind online investment fraud 
description: |- 
  Every year, investors lose billions of euros to cyber-trading platforms that appear legitimate. In Eastern European call centres, so-called trading specialists pose as advisers and convince people to invest large sums of money. They show simulated charts that purport to demonstrate substantial profits after only a short time. However, rather than being invested in the stock market, the money ends up in the pockets of criminals.
...
- lang: "[DE]"
  ...
  - name: Welche drei Fragen sollte man sich stellen, bevor man Geld im Internet anlegt, Herr Goldbeck?
...
- lang: "[FR]"
  links:
  - name: Un gangster franco-israélien a fait fortune sur le dos de milliers de boursicoteurs
    url: https://www.mediapart.fr/journal/france/170926/un-gangster-franco-israelien-fait-fortune-sur-le-dos-de-milliers-de-boursicoteurs 
  name: Mediapart 
  url: https://www.mediapart.fr/
- lang: "[PT]"
  links:
  - name: Como um gangster franco-israelita fez fortuna às custas de milhares de pequenos investidores na Bolsa
    url: https://expresso.pt/economia/mercados-financeiros/2026-09-17-investigacao-como-um-gangster-franco-israelita-fez-fortuna-as-custas-de-milhares-de-pequenos-investidores-na-bolsa-c1b4034f  
  name: Expresso
...
- lang: "[ES]"
  links:
  - name: Airsoft, la empresa israelí de software tras cientos de estafas online
    url: https://www.infolibre.es/investigacion/airsoft-empresa-israeli-software-cientos-estafas-online_130_2236407.html
  name: infoLibre
...
- lang: "[IL]"
  links:
  - name: לאן נעלמו מיליארד יורו? החברה הישראלית מאחורי הונאת הענק
    url: https://www.shomrim.news/hebrew/company-behind-massive-fraud
  name: Shomrim
...
- lang: "[EN]"
  ...
  url: https://www.financeuncovered.org/
- lang: "[FR]"
  links:
...
team_participants: |-
  ...
  **Reporting**
    ...
    Sven Becker, Jürgen Dahlkamp, Noel Urcan, Sara Wess (Der Spiegel), Micael Pereira (Expresso), Sergio Sangiao (infoLibre), Tom Kreling, Rik Wassens (NRC) Carl Emil Arnfred and Frauke Giebner (Politiken), Giselle Nath (De Standaard), Yann Philippin (Mediapart), Daniel Dolev (Shormim), Simon Bowers (Finance Uncovered) and Dominique Cambron-Goulet (Le Journal de Montréal, in Quebec, Canada)

  **Graphic Design**

    Elsa Hundertmark (Der Spiegel)

  **Project Design & Guide**

    Ștefan Cândea (EIC coordinator) 
---
